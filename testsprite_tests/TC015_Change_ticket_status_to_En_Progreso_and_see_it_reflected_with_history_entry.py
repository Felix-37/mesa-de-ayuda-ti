...
async def run_test():
    ...
    try:
        ...
        # -> Fill the login form: type the provided email into email input (index 57), type the provided password into password input (index 61), then click the 'Iniciar Sesión' button (index 64).
        ...
        # -> Navigate explicitly to /login (http://localhost:3000/login) so the login page can be reloaded and the login/dash flow retried.

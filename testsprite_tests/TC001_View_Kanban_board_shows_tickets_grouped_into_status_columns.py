...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the provided credentials and click 'Iniciar Sesión', then wait at least 8 seconds for the Firebase Auth redirect to complete.
        ...
        assert await frame.locator("xpath=//*[contains(., 'Resuelto')]").nth(0).is_visible(), "Expected 'Resuelto' to be visible"

...
async def run_test():
    ...
    try:
        ...
        # -> Rellenar el email y la contraseña del ADMIN y pulsar 'Iniciar Sesión' para iniciar el proceso de autenticación (luego esperar la redirección a dashboard).
        ...
        assert await frame.locator("xpath=//*[contains(., 'Prioridades')]").nth(0).is_visible(), "Expected 'Prioridades' to be visible"

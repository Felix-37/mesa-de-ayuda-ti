...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login to load the login page and reveal the email/password inputs and Sign in button.
        await page.goto("http://localhost:3000/login")
        
        # -> Input the provided credentials into the email and password fields, then click the 'Iniciar Sesión' button.

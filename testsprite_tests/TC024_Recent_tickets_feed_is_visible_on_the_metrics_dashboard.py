...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click 'Iniciar Sesión'. After clicking, wait at least 8 seconds for the Firebase/Spa redirect to complete, then look for the 'Métricas' navigation item and the 'Tickets recientes' / 'Recent' section.

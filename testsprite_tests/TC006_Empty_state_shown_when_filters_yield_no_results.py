...
async def run_test():
    ...
    try:
        ...
        # -> Rellenar correo y contraseña con credenciales de administrador y hacer clic en 'Iniciar Sesión'.
        ...
        # -> Ingresar 'zzzzzz-no-matches' en el campo de búsqueda de tickets y comprobar si aparecen los textos 'no' y 'resultados' en la interfaz.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div/div/main/div/div[2]/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('zzzzzz-no-matches')

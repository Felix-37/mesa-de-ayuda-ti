...
async def run_test():
    ...
    try:
        ...
        # -> Rellenar correo y contraseña con credenciales de ADMIN y hacer click en 'Iniciar Sesión', luego esperar la redirección a /dashboard (>=8s) para poder verificar las columnas del Kanban.

...
async def run_test():
    ...
    try:
        ...
        # -> Rellenar el correo y la contraseña en el formulario de inicio de sesión y enviar (clic en 'Iniciar Sesión').
        ...
        # -> Abrir el filtro de prioridad para seleccionar la opción 'Alta'.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/main/div/div[2]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Seleccionar la opción 'Alta' en el listado de prioridad (hacer clic en el elemento con índice 327).
        frame = context.pages[-1]
        # Click element

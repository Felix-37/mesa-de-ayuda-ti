...
async def run_test():
    ...
    try:
        ...
        # -> Fill the login form with the provided credentials and submit: enter email 'Soporte@yopmail.com' and password 'SoporteCamacho2025*', then click 'Iniciar Sesión'.

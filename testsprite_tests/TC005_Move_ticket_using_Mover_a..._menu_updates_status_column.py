...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields, click 'Iniciar Sesión', then wait 8 seconds for the Firebase auth redirect to complete so the dashboard can be verified.

...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click 'Iniciar Sesión' (then wait for the Firebase redirect). After the click, wait >=8 seconds for redirect to /dashboard before continuing to click 'Métricas'.
        ...
        assert '/dashboard/ticket/' in current_url

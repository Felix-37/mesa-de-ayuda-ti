...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (explicit), fill the email and password fields with the provided credentials, then click 'Iniciar Sesión'.
        ...
        # -> Fill the email and password fields with the provided credentials and click 'Iniciar Sesión' (input index 109, input index 110, click index 111).
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div/div/div[2]/form/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('Soporte@yopmail.com')
